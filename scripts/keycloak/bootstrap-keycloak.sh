...
# Bootstrap script for Keycloak realm, clients, scopes, and users
# Runs the keycloak-bootstrap Helm chart as a Kubernetes Job
...
usage() {
  echo "Usage: $0 -f <values-file> [OPTIONS]"
  echo ""
  echo "Required:"
  echo "  -f, --values <file>               Helm values file for keycloak-bootstrap chart"
  echo ""
  echo "Options:"
  echo "  -n, --namespace <namespace>       Kubernetes namespace (default: $NAMESPACE)"
  echo "  -r, --release <name>              Helm release name (default: $BOOTSTRAP_RELEASE)"
  echo "  -c, --chart-dir <dir>             Chart directory (default: $CHART_DIR)"
  echo "  -h, --help                        Show this help message"
  echo ""
  echo "Examples:"
  echo "  $0 -f $CHART_DIR/examples/values.yaml"
  echo "  $0 -f my-values.yaml --namespace governance-stag"
}
...
if [ -z "$VALUES_FILE" ]; then
  echo -e "${RED}Error: Values file is required${NC}"
  echo ""
  usage
  exit 1
fi
...
echo -e "${BLUE}Keycloak Bootstrap for Governance Platform${NC}"
echo -e "${BLUE}===========================================${NC}"
echo ""
echo "Namespace:    $NAMESPACE"
echo "Release:      $BOOTSTRAP_RELEASE"
echo "Chart:        $CHART_DIR"
echo "Values:       $VALUES_FILE"
echo ""
echo "This will create:"
echo "- Governance realm"
...
echo "- Service account roles for backend client"
echo ""
